...
// Setup routes
let routesApiV1 = require('./routes-api-v1').setup(router, uploads, knex) // the 3 things we are sharing to routes=api file
app.use('/api/v1', routesApiV1) // loading routes in from routes-api-v1
